    ...
    if(userEmail) { 
        ...
        return (
            ...
            <div className="absolute inset-x-0 bottom-0">
                <h1 className="flex justify-center font-normal cursor-pointer mt-10 text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl" style={{fontFamily: 'Cookie', color: 'white'}}> 
